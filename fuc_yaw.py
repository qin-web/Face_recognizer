...
def get_image_points_from_landmark_shape(landmark_shape):
    ...
    image_points = np.array([
                                ...
                                (landmark_shape.part(37).x, landmark_shape.part(37).y),     # Left eye left corner
                                (landmark_shape.part(44).x, landmark_shape.part(44).y),     # Right eye right corne
...
def calculate(im):
    ...
    cv2.putText( im, euler_angle_str, (0, 120), cv2.FONT_HERSHEY_PLAIN, 3, (0, 0, 255), 1 )
    return im
